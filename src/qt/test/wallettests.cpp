...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SuchcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_suchcoin-qt -platform xcb      # Linux
//     src/qt/test/test_suchcoin-qt -platform windows  # Windows
//     src/qt/test/test_suchcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SuchcoinUnits::formatWithUnit(unit, balance, false, SuchcoinUnits::separatorAlways);
    ...
    // Amount input
    SuchcoinAmountField* amountInput = receiveCoinsDialog.findChild<SuchcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: suchcoin:")) != -1);
