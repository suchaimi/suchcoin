...
/** Suchcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SuchcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SuchcoinUnits(QObject *parent);

    /** Suchcoin units.
      @note Source: https://en.suchcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SUC,
...
typedef SuchcoinUnits::Unit SuchcoinUnit;
