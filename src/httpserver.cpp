// Copyright (c) 2015-2017 The Suchcoin Core developers
...
{
    RenameThread("suchcoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/suchcoin/suchcoin/pull/6990)
